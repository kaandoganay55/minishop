      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Alışverişe başlamak için ücretsiz hesap oluşturun
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h3 className="text-center text-lg font-semibold text-gray-900 mb-4">KadoShop Avantajları</h3>
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-700">Ücretsiz kargo imkanı</span>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-700">Favori ürünlerinizi kaydedin</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v13m0-13V6a2 2 0 112 0v1m-2 0V6a2 2 0 00-2 0v1m2 0V9.5m0 0v-2m0 2v2m0-2h4.5m0 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v.5m4.5 0h-4.5" />
                </svg>
              </div>
              <span className="text-sm text-gray-700">Özel indirimler ve kampanyalar</span>
            </div>
          </div>
        </div>
      </div>
